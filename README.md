...
- 📌 **Novel list**: Title, author, genre, status, and description.
- 📖 **Chapters**: Chapter content for novels or images for manga.
- 🏷 **Genres & Tags**: Categorization for easier sorting.
- However, you need to manually configure the elements. :))

## 🚀 Key Features
✅ **Automated data scraping** based on input URLs.  
✅ **Save data** to a JSON file.  
✅ **Download novels** as text or images (for manga) (not tested yet, but theoretically possible).  
...
## 📜 License & Disclaimer
⚠️ **This project is for research and educational purposes only. Do not use it to violate website terms of service!**

---
💡 Contribute or report issues at [GitHub Issues](https://github.com/AhnMaph)
